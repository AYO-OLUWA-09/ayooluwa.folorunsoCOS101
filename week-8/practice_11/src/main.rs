fn main() {
     ...
     // create the slice of 2nd and 3rd elements
     let slice1 =&numbers[1..3];
     println!("2nd and 3rd elements sliced = {:?}",slice1);

     // omit the start index
     let slice2 = &numbers[..3];
     // This means the slice starts from index o and goes up to index 3(exclusive)
